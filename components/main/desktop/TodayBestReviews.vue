<template>
  <div class="main_st_review_wrap">
    <div v-for="(review, reviewIndex) in reviews" :key="`review-${reviewIndex}`" class="main_st_review" style="width: 675px;">
      <today-best-review-swiper :review="review"/>
        ...
        <figcaption class="figcaption review_text_top bdb_0">
          ...
          <a class="cursor" @click="openReviewAwardModal(review)">
            ...
            <div class="main_rv_write">
              <div class="reviewstatus_wrap fl one">
                <div class="review_star">
                  <span class="star">
                    <i></i>
                  </span>
              ...
              <div class="fr">
                <div class="dp_flex">
                  <div class="review_star">
                    ...
                    <span class="mgl15"><em class="txt_s">{{ review.createDate | dateFormat }}</em></span>
                  </div>
                </div>
              </div>
            </div>
...
import TodayBestReviewSwiper from '@/components/main/desktop/TodayBestReviewSwiper';
...
export default {
  ...
  components: {ReviewPricePanel, TodayBestReviewSwiper, StarRatingViewer},
  props: {
    reviews: {},
  },
  methods: {
